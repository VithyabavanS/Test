...
while True:
    word1 = checking("PASS")        # calling 'checking' function
    word2 = checking("DEFER")
    word3 = checking("FAIL") 

    Total = word1 + word2 + word3
    if Total != 120:                # Check if total is 120
        ...
        # cresting list based on the inputs
        Input_Data.append(result + " - " + str(word1) + ", " + str(word2) + ", " + str(word3))
...
print()
for i in Input_Data:                                         
    print(i)           # print items in the list 'Input_Data'
