...
while True:
    while True:
        ...
        word1 = checking("PASS")
        break
    word2 = checking("DEFER")      # calling 'checking' function
    word3 = checking("FAIL")
    ...
    if Total != 120:
        ...
        Dic_for_input[student_id] = result + " - " + str(word1) + ", " + str(word2) + ", " + str(word3)  # New for part4
...
print("---------------------------------------------------------------")
print()
for i in Dic_for_input:                                     
    Input_result += i + " : " + Dic_for_input[i] + " "      
print(Input_result)                                            # print data from dictionary
